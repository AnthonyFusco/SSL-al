...
law "markov1" ofType "MarkovChain" givenMatrix ([[0.3,0.2,0.5],[0.15,0.8,0.05],[0.25,0.25,0.5]])
...
law "poly1" ofType "MathFunction" itReturns "INT" withExpressions (["0": "x>0.22","22" : "x<0.22"])
law "poly2" ofType "MathFunction" itReturns "STRING" withExpressions (["Shiny": "x>0.22","Rainy" : "x<0.22"])
