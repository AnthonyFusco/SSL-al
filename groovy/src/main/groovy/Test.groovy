...
law "file1" ofType "File" fromPath "/home/ringo/Bureau/SSL-al/groovy/src/main/resources/rawdata/data1.csv" format "CSV" withColumns ([t: 0, s: 1, v: 8])

law "poly1" ofType "MathFunction" itReturns "INT" withExpression "0", "x<0.22"
