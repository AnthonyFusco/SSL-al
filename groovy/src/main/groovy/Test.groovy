...
law "markov1" ofType MarkovLaw givenMatrix ([[0.3,0.2,0.5],[0.15,0.8,0.05],[0.25,0.25,0.5]]) changeStateFrequency 1/20.s
...
sensorLot "markov" sensorsNumber 2 withLaw "markov1" withFrequency 5/s //eq 5/2.s
