...
//#define MARKOV => ofType MarkovLaw changeStateFrequency 1 / 20.s

randomLaw "randomLaw" //useless, could be inlined

//law "markovLaw" ofType MarkovLaw changeStateFrequency 1 / 20.s withMatrix([[0.3, 0.2, 0.5], [0.15, 0.8, 0.05], [0.25, 0.25, 0.5]])

law "markovLaw" MARKOV withMatrix([[0.3, 0.2, 0.5], [0.15, 0.8, 0.05], [0.25, 0.25, 0.5]])
law "markovLaw2" MARKOV withMatrix([[0.3, 0.7], [0.15, 0.85]])
